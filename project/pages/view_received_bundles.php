...
// filtering data
$select_bundle = "select * from collect_bundles ORDER BY exam_names";
$select_bundle_result = mysqli_query($con, $select_bundle);
...
<body>
    ...
    <div class="hero_section mt-1">
        <div class="container bg-light">
            <h5 class="p-2 text-dark mt-3 mb-4"><strong>View Received Control Bundles</strong></h5>

            <div class="enroll_data p-2">
                <form method="post" class="row mt-2 mb-3 pb-1" id="enroll_data_row">
                    <div class="row mt-2">
                        <div class="col-md-9">
                            <select class="form-select form-select-m" name="exams" id="">
                                <option>--- Select Examination---</option>
                                <!-- exam name -->
                                <?php

                                if (mysqli_num_rows($select_bundle_result) > 0) {
                                    while ($row = mysqli_fetch_assoc($select_bundle_result)) {
                        ...
                        <div class="col-md-3">
                            <button type="submit" name="getting_bundle" class="form-control btn btn-light">search</button>
                        </div>
                    </div>
                </form>
                <!---------- data table--------->
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                            $i=0;
                            if (isset($_POST['getting_bundle'])) {

                                $data_select = $_POST['exams'];
                                $select_valuator = "select * from collect_bundles where exam_names ='$data_select'";
